        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-body">
                ...
                <?php 
                            ...
                            foreach ($padre as $row) {
                              ...
                              <tr>
                                  ...
                                  <td>'.$row["celular"].'</td>   
                                  <td>
                                    <a href="../registros/modificar_padre.php?cod='.$row["id_padre"].'" class="btn btn-warning">Modificar</a>
                                    <a href="../scripts/eliminar_padres.script.php?cod='.$row["id_padre"].'" class="btn btn-danger">Eliminar</a>
                                  </td>
                              </tr>
              ...
              <button type="button" onClick="location.href = '../registros/registro_padres.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</button>
              </div>
