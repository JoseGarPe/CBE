            ...
            <form role="form" action="../scripts/modificar_ma.script.php" method="post">
              <div class="box-body">
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" required="" value="'.$row["id_ma"].'" id="codigo" name="codigo" disabled>
                    </div>
                       <input type="hidden" name="alumno" value="'.$alumno.'" id="'.$alumno.'">
                <div class="form-group">
                <label for="nombre">Estado</label>
                <input type="text" class="form-control" required="" value="'.$row["estado"].'" id="estado" name="estado" >
                   
                </div>
               <div class="form-group">
                      <label for="nombre">Fecha Pagado</label>
                      <input type="date" class="form-control" required="" value="'.$row["fech_pago"].'" id="fech_pago" name="fech_pago" placeholder="YY-MM-DD">
                    </div>
                <div class="form-group">
                      <label for="nombre">Mora</label>
                       <input type="text" class="form-control" required="" value="'.$row["mora"].'" id="mora" name="mora" >
                    </div> ';
