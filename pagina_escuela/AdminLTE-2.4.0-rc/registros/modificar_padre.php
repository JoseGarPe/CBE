 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Area mantenimiento
        <small>Modificar de Padre</small>
      </h1>
    </section>
      ...
      <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/modificar_padres.script.php" method="post">
              <div class="box-body">
                            ...
                            $padre = $miPadre->consultarPadre($codigo);
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly value="'.$row["id_padre"].'" id="codigo" name="codigo" maxlength="5" minlength="5">
                </div>
