      ...
      <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/registro_usuario.script.php" method="post">
              <div class="box-body">
                  
                <div class="form-group">
                  <label for="codigo">Codigo</label>
                  <input type="text" class="form-control" required="" id="codigo" name="codigo" maxlength="8" minlength="8" placeholder="Ej. VM335122">
                </div>
              ...
              <div class="box-footer">
                ...
                <input type="button" class="btn btn-danger" onClick="location.href = '../listas/lista_usuario.php'" name="cancel" value="Cancelar" >
              </div>
            </form>
