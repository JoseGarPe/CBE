...
';
    ...
    if ($tipo=='PRE01') {
          ...
          <a href="../listas/lista_mantenimiento_preventivo.php" class="btn btn-success pull-right"> Regresar</a>
          </button>
        </div>
      </div>
    </section>
...
<div class="clearfix"></div>
       ...
       echo'
          ...
          <a href="../listas/lista_mantenimiento_correctivo.php" class="btn btn-success pull-right"> Regresar</a>
          </button>
        </div>
      </div>
    </section>
