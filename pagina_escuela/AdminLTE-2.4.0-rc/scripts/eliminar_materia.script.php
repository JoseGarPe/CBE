   ...
   //Instancia del objeto
    ...
    $verificar = $materia->eliminarMateria($codigo);
      ...
      if ($verificar == true) {
        ...
        header('Location: ../listas/lista_materiaa.php?error=abcFTY778mclhgGHLCVbyyt8976poooYusnbsjaja8654OUYGVBM987654kjhgvSJHGFkjhgfdhjiuytredfghjvcx23456789okKIUYTRDFGH098765reS');
    }
