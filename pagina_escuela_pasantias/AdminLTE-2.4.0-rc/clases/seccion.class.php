...
function cargaSeccionNom2($codigo){

		$sql = $this->db->query("SELECT s.id_seccion as id, s.nombre as seccion FROM detalle_grado dtg INNER JOIN seccion s ON dtg.id_seccion=s.id_seccion WHERE dtg.id_grado='$codigo'"); 
        $periodo = $sql->fetch_all(MYSQLI_ASSOC); 
        return $periodo;  
