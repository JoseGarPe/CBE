...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Actividades
        <small>Lista de actividades</small>
      </h1>
    </section>
    <br>
    <?php 
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                            ...
                            $actividad = $misActividades->cargarActividad();
                            ...
                            foreach ($actividad as $row) {
                              ...
                              <tr>
                                  <td>'.$row["nombre"].'</td>
                                  <td>
                                    <a href="../registros/modificar_actividad.php?cod='.$row["id_actividad"].'" class="btn btn-warning">Modificar</a>
                                    <a href="../scripts/eliminar_actividad.script.php?cod='.$row["id_actividad"].'" class="btn btn-danger">Eliminar</a>
                                  </td>
                              </tr>
              ...
              <button type="button" onClick="location.href = '../registros/registro_actividad.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</button>
              </div>
