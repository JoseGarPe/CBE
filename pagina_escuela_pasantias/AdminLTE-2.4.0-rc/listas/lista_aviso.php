        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-body">
                ...
                <?php 
                            ...
                            foreach ($aviso as $row) {
                              ...
                              <tr>
                                  ...
                                  <td>'.$row["fecha"].'</td>
                                  <td>
                                  <a href="../registros/modificar_aviso.php?cod='.$row["id_aviso"].'" class="btn btn-warning">Modificar</a>
                                    <a href="../scripts/eliminar_aviso.script.php?cod='.$row["id_aviso"].'" class="btn btn-danger">Eliminar</a>
                                   </td>
                                   <td>
                              ';
                                if ($row["Estado"]=="Si") {
                                echo'<a href="../scripts/publicar.script.php?cod='.$row["id_aviso"].'&estado=No" class="btn btn-danger">Desactivar</a>
                                  </td>
                              </tr>';
                                # code...
                              } else{
                                echo'<a href="../scripts/publicar.script.php?cod='.$row["id_aviso"].'&estado=Si" class="btn btn-info">Activar</a>
                                  </td>
                              </tr>';
              ...
              <button type="button" onClick="location.href = '../registros/registro_aviso.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</button>
              </div>
