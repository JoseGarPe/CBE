            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                            ...
                            $actividad = $misperiodos->cargarActividad2();
                            ...
                            foreach ($actividad as $row) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                    <a href="../registros/modificar_detalle_actividad.php?cod='.$row["id"].'" class="btn btn-warning">Modificar</a>
                                  </td>
                              </tr>
              ...
              <button type="button" onClick="location.href = '../registros/registro_detalle_actividad.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</button>
              </div>
