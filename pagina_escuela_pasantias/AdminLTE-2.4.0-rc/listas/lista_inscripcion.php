...
xmlhttp.open("POST","../listas/inscripciones.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
...
<section class="content">
      <div class="row">
        <div class="col-xs-12">
            <div class="box">
           <div class="box-body">
             <button type="button" onClick="location.href = '../registros/registro_inscripcion.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Nueva inscripcion</button>
