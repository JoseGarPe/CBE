        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-body">
                ...
                <?php 
                            ...
                            foreach ($madre as $row) {
                              ...
                              <tr>
                                  ...
                                  <td>'.$row["celular"].'</td>   
                                  <td>
                                    <a href="../registros/modificar_madre.php?cod='.$row["id_madre"].'" class="btn btn-warning">Modificar</a>
                                    <a href="../scripts/eliminar_madres.script.php?cod='.$row["id_madre"].'" class="btn btn-danger">Eliminar</a>
                                  </td>
                              </tr>
              ...
              <button type="button" onClick="location.href = '../registros/registro_madres.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</button>
              </div>
