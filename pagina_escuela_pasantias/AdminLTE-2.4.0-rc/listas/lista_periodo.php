            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                            ...
                            $periodos = $misperiodos->cargarPeriodo();
                            ...
                            foreach ($periodos as $row) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                    <a href="../registros/modificar_periodo.php?cod='.$row["id_periodo"].'" class="btn btn-warning">Modificar</a>
                                    <a href="../scripts/eliminar_periodo.script.php?cod='.$row["id_periodo"].'" class="btn btn-danger">Eliminar</a>
                                  </td>
                              </tr>
              ...
              <button type="button" onClick="location.href = '../registros/registro_periodo.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</button>
              </div>
