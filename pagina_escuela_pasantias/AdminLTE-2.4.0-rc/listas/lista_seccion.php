...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Secciones escolares
        <small>Lista de secciones</small>
      </h1>
    </section>
    <br>
    <?php 
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                            ...
                            $seccion = $misseccion->cargaSeccion();
                            ...
                            foreach ($seccion as $row) {
                              ...
                              <tr>
                                  <td>Seccion '.$row["nombre"].'</td>
                                  <td>'.$row["estado"].'</td>
                                  <td>
                                    ';

                                    if ($row["estado"]=="Activo") {
                                echo'<a href="../scripts/eliminar_seccion.script.php?cod='.$row["id_seccion"].'&estado=Inactivo" class="btn btn-danger">Desactivar</a>
                                  </td>
                              </tr>';
                                # code...
                              } else{
                                echo'<a href="../scripts/eliminar_seccion.script.php?cod='.$row["id_seccion"].'&estado=Activo" class="btn btn-info">Activar</a>
                                  </td>
                              </tr>';
              ...
              <button type="button" onClick="location.href = '../registros/registro_seccion.php'" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</button>
              </div>
