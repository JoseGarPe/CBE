        ...
        <li class="header">MENU</li>
            ...
            <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span>
             ...
             <ul class="treeview-menu">
                  <li><a href="#"><i class="fa fa-circle-o"></i>Asig. Actividades</a></li>
                  <li><a href="#"><i class="fa fa-circle-o"></i>Asig. Grados</a></li>
                  <li><a href="#"><i class="fa fa-circle-o"></i>Asig. Materias</a></li>
                  <li><a href="#"><i class="fa fa-circle-o"></i>Asig. Horarios</a></li>
                  <li><a href="#"><i class="fa fa-circle-o"></i>Asig. Cursos</a></li>
              </ul>
            </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              ...
              <li><a class="" href="/pagina_escuela_pasantias/adminLTE-2.4.0-rc/listas/lista_seccion.php"><i class="fa fa-circle-o"></i>Secciones</a></li>
              <li><a class="" href="#"><i class="fa fa-circle-o"></i>Observaciones</a></li>
              <li><a class="" href="/pagina_escuela_pasantias/adminLTE-2.4.0-rc/listas/lista_materia.php"><i class="fa fa-circle-o"></i>Materia</a></li>
