...
?>
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/modificar_contralum.script.php" method="post">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <input type="button" class="btn btn-danger" onClick="location.href = '../listas/notas_alumno.php'" name="cancel" value="Cancelar" >
              </div>
            </form>
            </div>
          </div>
