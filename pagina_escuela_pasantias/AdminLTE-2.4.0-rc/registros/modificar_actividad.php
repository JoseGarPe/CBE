 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Actividades
        <small>Modificar de actividades</small>
      </h1>
    </section>
      ...
      <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/modificar_actividad.script.php" method="post">
              <div class="box-body">
                            ...
                            $actividad = $misActividades->cargarActividades($codigo);
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly value="'.$row["id_actividad"].'" id="codigo" name="codigo" maxlength="5" minlength="5">
                </div>
              ...
              <div class="box-footer">
                ...
                <input type="button" class="btn btn-danger" onClick="location.href = '../listas/lista_actividadPeriodo.php'" name="cancel" value="Cancelar" >
              </div>
            </form>
