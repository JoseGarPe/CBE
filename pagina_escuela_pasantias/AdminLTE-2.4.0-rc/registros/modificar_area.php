      ...
      <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/modificar_area.script.php" method="post">
              <div class="box-body">
                            ...
                            $area = $misAreas->cargarAreas($codigo);
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly value="'.$row["id_area"].'" id="codigo" name="codigo" maxlength="5" minlength="5">
                </div>
              ...
              <div class="box-footer">
                ...
                <input type="button" class="btn btn-danger" onClick="location.href = '../listas/lista_area.php'" name="cancel" value="Cancelar" >
              </div>
            </form>
