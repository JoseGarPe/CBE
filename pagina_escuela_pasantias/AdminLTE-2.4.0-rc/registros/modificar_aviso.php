      ...
      <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/modificar_aviso.script.php" method="post">
              <div class="box-body">
                            ...
                            $aviso = $miAvisos->consultarAviso($codigo);
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly value="'.$row["id_aviso"].'" id="codigo" name="codigo" maxlength="5" minlength="5">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" required="" value="'.$row["fecha"].'" id="fecha" name="fecha" placeholder="dd/mm/aa">
                </div>
                 <div class="form-group">
                  <label for="nombre">Descripcion</label>
                  <textarea class="ckeditor" required="" id="descripcion" name="descripcion" placeholder="Descripcion evento...">'.$row["descripcion"].'</textarea>
                </div>
