 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Codigos
        <small>Modificar de Codigo</small>
      </h1>
    </section>
      ...
      <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/modificar_codigo.script.php" method="post">
              <div class="box-body">
                       ...
                       <?php 
                            ...
                            $materia = $codi->consultarCodigo($codigo);
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly value="'.$row["id_cod"].'" id="codigo" name="codigo" maxlength="5" minlength="5">
                            </div>
                            ...
                            echo '<div class="form-group">
                                      ...
                                      $categoria = $tipo_codigo->consultarTCodigo();
                                        ...
                                        foreach ($categoria as $raw) {
                                                ...
                                                if ($row["id_tip_cod"]==$raw["id_tip_cod"]) {
                                                        
                                                      echo '
                                                          <option selected value="'.$raw["id_tip_cod"].'">'.$raw["nombre"].'</option>
                                                          ';

                                                }else{

                                                     echo '
                                                          <option value="'.$raw["id_tip_cod"].'">'.$raw["nombre"].'</option>
                                                          ';
