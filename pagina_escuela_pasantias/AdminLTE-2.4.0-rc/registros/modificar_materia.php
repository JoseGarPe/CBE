 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Materias
        <small>Modificar de Materia</small>
      </h1>
    </section>
      ...
      <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/modificar_materia.script.php" method="post">
              <div class="box-body">
                            ...
                            $miMaterias = new materia();

                            $materia = $miMaterias->consultarMateria($codigo);
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly value="'.$row["id_materia"].'" id="codigo" name="codigo" maxlength="5" minlength="5">
                </div>
