 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Alumnos
        <small>Registro de Alumno</small>
      </h1>
    </section>
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="box box-primary">
            ...
            <form role="form" action="../scripts/registro_alumno.script.php" method="post">
              <div class="box-body">

                <div class="form-group">
                  <label for="codigo">Codigo</label>
                  <input type="text" class="form-control" required="" id="codigo" name="codigo" maxlength="8" minlength="8" placeholder="Ej. CO001122">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required="" id="nie" name="nie" placeholder="Ej: 4589653">
                </div>
                <div class="form-group">
